...
public class HighlightView {
    ...
    private void initStyles(Context context) {
        ...
        AppPreferenceTools appPreferenceTools = new AppPreferenceTools(context);
        try {
            ...
            highlightColor = attributes.getColor(R.styleable.CropImageView_highlightColor, appPreferenceTools.getAccentColor());
