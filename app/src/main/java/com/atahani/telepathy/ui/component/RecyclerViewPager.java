...
import com.atahani.telepathy.adapter.RecyclerViewPagerAdapter;
import com.atahani.telepathy.ui.utility.ViewUtils;
...
/**
 * Recycler View Pager create recycler view like ViewPager
 */
public class RecyclerViewPager extends RecyclerView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyle) {
        ...
        mWidthOfView = a.getDimensionPixelOffset(R.styleable.RecyclerViewPager_widthOfView,0);
        a.recycle();
    }
    ...
    public void setWidthOfView(int mWidthOfView) {
        this.mWidthOfView = mWidthOfView;
    }
